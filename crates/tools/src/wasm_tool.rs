...
impl Tool for WasmTool {
    ...
    fn description(&self) -> &str {
        "Execute a WASM-based tool in a secure sandbox."
    }
    ...
    async fn call(&self, args: Value) -> AgentResult<String> {
        ...
        let call_fn = instance
            ...
            .map_err(|_| {
                AgentError("WASM module does not export 'call(i32, i32) -> i64'".to_string())
            })?;

        let alloc_fn = instance
            .get_typed_func::<i32, i32>(&mut store, "alloc")
            .map_err(|_| {
                AgentError("WASM module does not export 'alloc(i32) -> i32'".to_string())
            })?;
