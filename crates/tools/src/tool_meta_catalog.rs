...
pub fn build_default_catalog() -> ToolMetaCatalog {
    let entries = vec![
        ...
        // --- FileSystem ---
        meta("replace_file_content", "Strictly replace content chunks in a file safely", ToolCategory::FileSystem, local_fs()),
        meta("view_file", "Read file contents with line numbers", ToolCategory::FileSystem, read_fs()),
        meta("list_dir", "List directory contents with metadata", ToolCategory::FileSystem, read_fs()),
